...
router.delete("/api/social/follow", (req, res) =>
...
router.post("/api/friend/remove", (req, res) =>
  socialController.removeFriend(req, res),
);
router.post("/api/friend/accept", (req, res) =>
  socialController.acceptFriend(req, res),
);
router.get("/api/friend/friends", (req, res) =>
  socialController.getFriends(req, res),
);
router.post("/api/friend/ignore", (req, res) =>
  socialController.ignore(req, res),
);
router.delete("/api/friend/unignore", (req, res) =>
  socialController.unignore(req, res),
);
...
router.get("/api/comment/feed", (req, res) =>
  comentsController.getComments(req, res),
);
router.delete("/api/comment/feed", (req, res) =>
  comentsController.deleteComment(req, res),
);

router.post("/api/gallery/comment", (req, res) =>
  galleryController.addComment(req, res),
);
router.delete("/api/gallery/comment", (req, res) =>
  galleryController.deleteComment(req, res),
);
...
router.post("/api/gallery", filesController.multer.single("file"), (req, res) =>
  galleryController.addPhotoProfile(req, res),
);
...
router.post("/api/comment/like", (req, res) =>
  comentsController.likeComment(req, res),
);
router.delete("/api/comment/like", (req, res) =>
  comentsController.dislikeComment(req, res),
);

router.post("/api/gallery/comment/like", (req, res) =>
  galleryController.likeComment(req, res),
);
router.delete("/api/gallery/comment/like", (req, res) =>
  galleryController.dislikeComment(req, res),
);
router.delete("/api/gallery/like", (req, res) =>
  galleryController.deleteLike(req, res),
);
router.post(
  "/api/gallery/like",
  filesController.multer.single("file"),
  (req, res) => galleryController.addPhoto(req, res),
);

router.post("/api/profile/like", (req, res) => profileController.likeProfile);
router.delete(
  "/api/profile/like",
  (req, res) => profileController.dislikeProfile,
);
...
router.get("/api/match/matches", (req, res) =>
  matchController.loadMatches(req, res),
);
...
router.post("/api/match/like", (req, res) =>
  matchController.like(req, res, req.app.get("sendPacketToUser")()),
);
...
router.post("/api/chat/typing", (req, res) =>
  chatController.routeApi(req, res, req.app.get("clients")()),
);
